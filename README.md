...
- [CI Compliance Standard](docs/CI_COMPLIANCE_STANDARD.md) — **INV-CI-COMPLY-1/2:** required steps per repo type (mandatory unless N/A); compliance checker runs in docs CI and fail-closed (PR must pass).
